...
<div markdown="0"><div class="sec-divider"><span class="sec-divider-label">Services</span><span class="sec-divider-line"></span></div></div>

- Journal Reviewer: Nature, Nature Machine Intelligence
- Conference Reviewer: NeurIPS'26, ICML'26 (Silver Reviewer), ACL'26
...
<div markdown="0"><div class="subsec-label">General Agents</div></div>

1. MMSkills: Towards Multimodal Skills for General Visual Agents. Under Review 2026.
2. MuSEAgent: A Multimodal Reasoning Agent with Stateful Experiences. Under Review 2026.
3. OmniGAIA: Towards Native Omni-Modal AI Agents. Under Review 2026.
4. Tool-Genesis: A Task-Driven Tool Creation Benchmark for Self-Evolving Language Agent. Under Review 2026.
5. Agent2World: Learning to Generate Symbolic World Models via Adaptive Multi-Agent Feedback. Under Review 2026.
6. LoopTool: Closing the Data–Training Loop for Robust LLM Tool Calls. ACL 2026.
...
<div markdown="0"><div class="subsec-label">LLM Reasoning</div></div>

1. Curing Miracle Steps in LLM Mathematical Reasoning with Rubric Rewards. ACL 2026.
2. DeepCompress: A Dual Reward Strategy for Dynamically Exploring and Compressing Reasoning Chains. ICLR 2026.
3. REA-RL: Reflection-Aware Online Reinforcement Learning for Efficient Large Reasoning Models. ICLR 2026.
